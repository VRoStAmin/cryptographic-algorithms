...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(argv[1], "encrypt") == 0 && argc == 3) {
        ...
        free(plaintext);
            ...
            unsigned char *cipher1_hex = hex_to_bytes(cipher1_string);
            unsigned char *cipher2_hex = hex_to_bytes(cipher2_string);
            ...
            const char *plaintext2 = "stream ciphers break if you ever reuse the keystream!";
            unsigned char *plain1_bytes = (unsigned char *)plaintext1;
            unsigned char *plain2_bytes = (unsigned char *)plaintext2;
